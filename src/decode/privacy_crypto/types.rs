//! Privacy pool ciphertext / plaintext types and the `SecretFelt` wrapper.
//!
//! Vendored from `crates/discovery-core/src/privacy_pool/types.rs` of
...
/// Ciphertext for an ECDH-based encryption of a private key.
